      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            <h4 className="min-w-0 text-sm font-semibold leading-tight line-clamp-2">
              {item.name}
            </h4>
            {item.comingSoon ? (
              ...
              <Badge className="shrink-0 gap-1 bg-green-600 text-white hover:bg-green-600/90 text-[10px] border-0 shadow-sm">
