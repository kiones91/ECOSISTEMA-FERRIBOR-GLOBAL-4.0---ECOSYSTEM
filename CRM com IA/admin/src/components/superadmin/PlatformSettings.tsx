              ...
              <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={`Ex: ${BRAND.platformName}`}
                  />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    placeholder="https://app.buffallos.com.br"
                  />
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => update({ powered_by_text: e.target.value })}
                    placeholder={`Powered by ${BRAND.platformName}`}
                />
                <p className="text-xs text-muted-foreground">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder={`${BRAND.platformName} — Plataforma de vendas`}
                  />
                  <p className="text-xs text-muted-foreground">
