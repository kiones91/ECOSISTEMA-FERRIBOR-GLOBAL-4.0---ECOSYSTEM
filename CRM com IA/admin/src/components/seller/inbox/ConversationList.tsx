...
import { Search, Filter, Globe, MessageCircle, Instagram, Mail, Phone, Plus, Volume2, VolumeX, User, Bot, Facebook, ClipboardList } from 'lucide-react';
...
interface ConversationListProps {
  ...
  /** Filtro Messenger / Instagram / WhatsApp (aba Inbox). */
  channelFilterSlot?: React.ReactNode;
  /** Texto extra quando a lista está vazia (ex.: canais conectados). */
...
const channelIcons: Record<string, React.ReactNode> = {
  ...
  facebook_lead_ads: <ClipboardList className="h-3 w-3" />,
      ...
      <ScrollArea className="flex-1 bg-muted/20">
        {isLoading ? (
          ...
          <div className="p-10 text-center text-muted-foreground">
            ...
            {emptyStateHint && (
              <p className="text-xs mt-3 text-muted-foreground/90 max-w-[240px] mx-auto leading-relaxed">
                {emptyStateHint}
              </p>
            )}
          </div>
                    ...
                    <div
                      className={cn(
                        ...
                        conv.channel === 'whatsapp'
                          ...
                          ? 'bg-gradient-to-tr from-purple-500 via-pink-500 to-orange-400 text-white'
