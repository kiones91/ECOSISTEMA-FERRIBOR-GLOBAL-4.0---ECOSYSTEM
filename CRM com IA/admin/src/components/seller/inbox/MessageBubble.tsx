...
export interface MessageBubbleProps {
  ...
  /** Visitante respondeu depois desta mensagem → exibir lido (✓✓ azul). */
  hasLaterVisitorReply?: boolean;
}
...
export function MessageBubble({
  ...
  const effectiveStatus = applyThreadReadInference(
    resolveMessageDeliveryStatus(
      metadata as Record<string, unknown> | undefined,
      status,
      { isOutbound: !isVisitor },
    ),
