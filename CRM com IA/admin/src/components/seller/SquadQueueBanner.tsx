...
const useMySquadQueue = () => ({ data: [], isLoading: false });
const useAssumeNextLead = () => ({ mutateAsync: async () => {}, isPending: false });
const useAssumeSpecificLead = () => ({ mutateAsync: async () => {}, isPending: false });
