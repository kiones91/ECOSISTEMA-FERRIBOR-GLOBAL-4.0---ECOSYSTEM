  ...
  public: {
    Tables: {
      ...
      finance_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "finance_entries_categoria_id_fkey"
      ...
      lead_pipeline_history: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "lead_pipeline_history_from_stage_id_fkey"
          ...
          {
            foreignKeyName: "lead_pipeline_history_to_stage_id_fkey"
            columns: ["to_stage_id"]
            isOneToOne: false
            referencedRelation: "pipeline_stages"
            referencedColumns: ["id"]
      ...
      course_sales_profile: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_sales_profile_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "lms_courses"
            referencedColumns: ["id"]
      ...
      course_agents: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_agents_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "lms_courses"
            referencedColumns: ["id"]
      ...
      course_objections: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_objections_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "lms_courses"
            referencedColumns: ["id"]
      ...
      course_knowledge_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_knowledge_sources_course_id_fkey"
            columns: ["course_id"]
            isOneToOne: false
            referencedRelation: "lms_courses"
            referencedColumns: ["id"]
      ...
      course_knowledge_chunks: {
        ...
        Relationships: [
          {
            foreignKeyName: "course_knowledge_chunks_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "course_knowledge_sources"
            referencedColumns: ["id"]
          },
          {
      ...
      social_channel_integrations: {
        Row: {
          channel_type: Database["public"]["Enums"]["social_channel_type"]
          created_at: string
          id: string
          is_active: boolean
          metadata: Json
      ...
      webchat_conversations: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "webchat_conversations_social_channel_id_fkey"
            columns: ["social_channel_id"]
            isOneToOne: false
            referencedRelation: "social_channel_integrations"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      ...
      public_cancel_booking_by_token: {
        Args: { p_reason?: string; p_token: string }
        Returns: Json
      }
      public_reschedule_booking_by_token: {
    ...
    Enums: {
      app_role: | "admin" | "comercial" | "suporte" | "conteudo"
      sector_rotation_strategy: | "round_robin" | "least_busy" | "random"
      social_channel_type: | "facebook" | "instagram"
      social_engagement_source: | "facebook_comment" | "instagram_comment"
