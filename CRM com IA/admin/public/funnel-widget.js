...
(function() {
  ...
  const config = {
    funnelId: funnelId,
    apiBase: 'https://snvzhngkjcjvgwvgyjqm.supabase.co/functions/v1',
    anonKey: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNudnpobmdramNqdmd3dmd5anFtIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njc5NjY0NTcsImV4cCI6MjA4MzU0MjQ1N30.xdbJEUSA1epBqTSEKL4SqUKJ4JQ7cBdKkoQ7ZegIrK8'
  };
